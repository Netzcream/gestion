...
use App\Repository\Cliente\EstadoCivilRepository;
...
class EstadoCivil
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Contacto::class, mappedBy="estado_civil")
     */
    private $contactos;
    ...
    public function removeContacto(Contacto $contacto): self
    {
        if ($this->contactos->removeElement($contacto)) {
            ...
            if ($contacto->getEstadoCivil() === $this) {
                $contacto->setEstadoCivil(null);
            }
        }
